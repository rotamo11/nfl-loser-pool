            ...
            if num_cols > 0:
                ...
                for i, p in enumerate(sorted(all_picks_res, key=lambda x: x["week"])):
                    with cols[i % num_cols]:
                        ...
                        st.markdown(
                            f"""
                            <div style="border:1px solid #cbd5e1; padding:6px 4px; border-radius:4px; text-align:center; background:#1d3d70ff; font-size:12px; font-family:sans-serif; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
