            ...
            if num_cols > 0:
                ...
                for i, p in enumerate(sorted(all_picks_res, key=lambda x: x["week"])):
                    with cols[i % num_cols]:
                        ...
                        st.markdown(
                            f"""
                            <div style="border:2px solid #1d3d70ff; padding:6px 4px; border-radius:4px; text-align:center; background:#cbd5e1; font-size:12px; font-family:sans-serif; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
