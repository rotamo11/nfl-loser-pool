...
# --- 1. BRAND HEADER DISPLAY MATRICES (Fixed syntax argument) ---
st.markdown(
    f"""
...
# Compile raw HTML grid into a string to load directly into the component iframe wrapper
html_iframe_payload = """
<style>
...
# 🚀 FIX: Render inside an HTML Component Sandbox Frame. 
# Scale height parameter to avoid internal clipping issues as 74 entries load.
