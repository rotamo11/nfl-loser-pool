            ...
            with col_target:
                if clean_team == "BYE":
                    ...
                    try:
                        ...
                        flat_html_tally = f"""<div style="display:inline-flex; align-items:center; gap:6px; font-family:sans-serif;"><img src="{svg_data_url}" width="26" height="18" style="object-fit:contain; vertical-align:middle;"/>{clean_team}<span style="font-weight:bold; font-size:15px; color:var(--text-color); vertical-align:middle;">{count}</span></div>"""
